...
const BASE_URL = "https://pixel-to-protocol-forge.lovable.app";
...
const entries: SitemapEntry[] = [
  ...
  { path: "/services/websites", changefreq: "monthly", priority: "0.9" },
  { path: "/services/mobile-apps", changefreq: "monthly", priority: "0.9" },
  { path: "/services/saas-platforms", changefreq: "monthly", priority: "0.9" },
